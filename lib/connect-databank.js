...
module.exports = function(session) {
    ...
    var DatabankStore = function(/*options*/_bank, parentLog, cleanupInterval) {

        var store = this;
//            cleanupInterval = options.cleanupInterval || 0,
//           parentLog = options.log || null;
    ...
    DatabankStore.prototype.get = function(sid, callback) {
        ...
        console.log("in DatabankStore.get:"+sid);
        ...
        async.waterfall([
            ...
            if (err) {
                ...
                console.log("DS last watterfall");
                console.log(session);
                console.log(callback.toString());
                //callback seems to be express-session stuff. then next() so thats good?
                callback(null, session);
            }
        });
    };
    ...
    DatabankStore.prototype.set = function(sid, sess, callback) {
        ...
        console.log("in DS.set sid: "+sid+ ", sess: "+sess);
        console.log(sess);
        ...
        async.waterfall([
            ...
            if (err) {
                ...
                /*
                self.get(sid, function(err, res){
                    console.log("DS...setandget:");
                    console.log(res);
                });
                */
